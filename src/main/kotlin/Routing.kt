...
fun Application.configureRouting() {
    ...
    val sukusService: SukusService by inject()
    ...
    routing {
        ...
        route("/sukus") {
            get {
                sukusService.getAllSukus(call)
            }
            post {
                sukusService.createSukus(call)
            }
            get("/{id}") {
                sukusService.getSukusById(call)
            }
            put("/{id}") {
                sukusService.updateSukus(call)
            }
            delete("/{id}") {
                sukusService.deleteSukus(call)
            }

            get("/{id}/image") {
                sukusService.getSukusImage(call)
            }
        }
